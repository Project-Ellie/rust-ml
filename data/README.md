...
[docs/references/catalogue.md](../docs/references/catalogue.md), and
the research sweep that found them is
[docs/references/findings-external-data.md](../docs/references/findings-external-data.md).
...
## Licensing rule ([ch. 14](../docs/14-openings-and-supervised-curriculum.md), decision D3)
...
re-adjudicated before any training use (ch. 14, decision D5).
